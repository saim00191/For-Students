        ...
        <div className="flex flex-col  items-center justify-center">
          <div className="flex flex-col items-center mdl:items-start mdl:justify-start justify-center">
            <div className="mdl:w-[644px] w-full h-auto lg:h-[248px] flex flex-col">
              ...
              <h2
                className={`${josefinFont.className} text-[40px] px-4 lg:px-0 text-center mdl:text-start lg:text-[53px] leading-[81.98px] tracking-[1.5px]`}
              >
            ...
            <button
              className={`${josefinFont.className} mt-8  cursor-pointer w-[163px] h-[50px] rounded-[2px] bg-accent text-[17px] text-white tracking-[2px] leading-[20px]`}
            >
              Shop Now
            </button>
          </div>
          ...
          <div className="flex justify-center mdl:justify-end relative items-center mdl:-mt-52 lgl:-mt-72 2xl:-mt-0 2xl:-mb-72  ">
              <div className="mdl:w-[706px] h-full mt-12 mdl:mt-0 mdl:h-[689px] bg-[#ECd2fa]/35 rounded-full flex items-center justify-center"> 
                  <div className="mdl:w-[629px] h-full mdl:h-[629px] bg-[#ECd2fa] rounded-full flex items-center justify-center">
