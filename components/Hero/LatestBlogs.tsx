...
import Image1 from "@/images/LatestBlogsImg1.png";
import Image2 from "@/images/LatestBlogsImg2.png";
import Image3 from "@/images/LatestBlogsImg3.png";
...
const author = [
  {id : 1 , name : "SaberAli", image : Image1},
  {id : 2  , name : "Surfauxion", image : Image2},
  {id : 3 , name : "SaberAli", image : Image3},
]
        ...
        {author.map((item) => (
          ...
          <div className="h-[239px] flex flex-col justify-between shadow-md w-full px-3">
            <div className="flex justify-between">
              ...
              <div className="w-[120px] h-[14px] flex justify-between items-center">
                <svg
                  width="11"
                  height="11"
                  viewBox="0 0 11 11"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_5608_430)">
                    <path
            ...
            <h3
              className={`${josefinFont.className} text-[14px] text-[#151875] leading-[16.41px]`}
            >
              Top esssential Trends in 2021
            </h3>
            <p
              className={`${josefinFont.className} font-normal text-[16px] leading-[30px] text-[#72718F]`}
            >
            ...
            <div>
              <button
                className={`${lato.className} text-[16px] font-normal hover:underline hover:text-accent`}
              >
                Read More
              </button>
            </div>
