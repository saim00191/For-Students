        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lgl:grid-cols-4 gap-4">
          {Images.map((item, index) => (
            ...
            >
              ...
              <div className="w-[100px] h-[30px] absolute top-[9px]  left-2 hidden group-hover:flex justify-between items-center">
                <span className="hover:bg-white rounded-full w-full h-full flex items-center justify-center cursor-pointer">
                  <svg
                    width="19"
                    height="19"
                    viewBox="0 0 19 19"
                ...
                <span className="hover:bg-white rounded-full w-full h-full flex items-center justify-center cursor-pointer">
                  ...
                  >
                    <path
                      ...
                      fill="url(#paint0_linear_5608_1636)"
                    />
                    <defs>
                      <linearGradient
                ...
                <span className="hover:bg-white rounded-full w-full h-full flex items-center justify-center cursor-pointer">
                  ...
                  >
                    <path
                      ...
                      fill="url(#paint0_linear_5608_1638)"
                    />
                    <defs>
                      <linearGradient
